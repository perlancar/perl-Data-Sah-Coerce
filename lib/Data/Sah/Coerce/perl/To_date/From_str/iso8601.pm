...
sub coerce {
    ...
    if ($coerce_to eq 'float(epoch)') {
        ...
        $res->{expr_coerce} = qq(do { my \$time; eval { \$time = \$8 ? Time::Local::timegm(\$7, \$6, \$5, \$3, \$2-1, \$1-1900) : \$4 ? Time::Local::timelocal(\$7, \$6, \$5, \$3, \$2-1, \$1-1900) : Time::Local::timelocal(0, 0, 0, \$3, \$2-1, \$1-1900) }; my \$err = \$@; if (\$err) { \$err =~ s/ at .+//s; ["Invalid date/time: \$err"] } else { [undef, \$time] } });
